...
#3. Do Quality Control of reads with Fastp (SINGLE)
##Loop for processing samples(only SINGLE Fastqs)
...
do
	...
	###Output names
	f1_qc=${OUTPUT_DIR}/${base}"_qc.fastq.gz"
...
#End script
echo "End Script(fastp_qc_SINGLE_polyg.sh)!"
